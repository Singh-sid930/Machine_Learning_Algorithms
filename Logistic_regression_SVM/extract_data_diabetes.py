...
def data_set():
	...
	with open('diabetes.dat', 'r') as f:
		for line in f:
			line_content = line.strip()
			content_word = line_content.split(',')

			n = len(content_word)
			if content_word[n-1] == 'tested_positive':
				Y_set.append(1)
			elif content_word[n-1] =='tested_negative':
				Y_set.append(0)
	print(len(Y_set))
...
pa_sgd_score1, ta_sgd_score1, pa_sgd1, ta_sgd1 = logregA_varying_regularization(0.00001,1)
pa_sgd_score2, ta_sgd_score2, pa_sgd2, ta_sgd2 = logregA_varying_regularization(0.1,1)
pa_sgd_score3, ta_sgd_score3, pa_sgd3, ta_sgd3 = logregA_varying_regularization(10,1)
pa_sgd_score4, ta_sgd_score4, pa_sgd4, ta_sgd4 = logregA_varying_regularization(0.000012,2)
pa_sgd_score5, ta_sgd_score5, pa_sgd5, ta_sgd5 = logregA_varying_regularization(0.12,2)
pa_sgd_score6, ta_sgd_score6, pa_sgd6, ta_sgd6 = logregA_varying_regularization(8,2)



print("Accuracy score for diabetes data set with norm 1 and lambda 0.00001")
...
print("Accuracy score for diabetes data set with norm 1 and lambda 0.1")
...
print("Accuracy score for diabetes data set with norm 1 and lambda 10")
...
print("Accuracy score for diabetes data set with norm 2 and lambda 0.00001")
...
print("Accuracy score for diabetes data set with norm 2 and lambda 0.1")
...
print("Accuracy score for diabetes data set with norm 2 and lambda 10")
