...
def data_set():
	...
	with open('wdbc.dat', 'r') as f:
		for line in f:
			...
			# print(content_word)
			n = len(content_word)
			if content_word[n-1] == 'B':
				Y_set.append(1)
			elif content_word[n-1] =='M':
				Y_set.append(0)
			else:
				continue
...
print("Accuracy score for wdbc data set with norm 1 and alpha 0.1")
...
print("Accuracy score for wdbc data set with norm 1 and alpha 0.001")
...
print("Accuracy score for wdbc data set with norm 1 and alpha 1")
...
print("Accuracy score for wdbc data set with norm 2 and alpha 0.1")
...
print("Accuracy score for wdbc data set with norm 2 and alpha 0.001")
...
print("Accuracy score for wdbc data set with norm 2 and alpha 1")
